...
func _ready():
	...
	$Sliders/Controls/MinXDirection/MinXDirection.value = self.MinXDirection
	$Sliders/Controls/MaxXDirection/MaxXDirection.value = self.MaxXDirection
...
func _process(delta):
	self.MinXDirection = $Sliders/Controls/MinXDirection/MinXDirection.value
	self.MaxXDirection = $Sliders/Controls/MaxXDirection/MaxXDirection.value
...
func createObject():
	...
	var newXDir = random.randf_range(MinXDirection, MaxXDirection)
	
	object.xDirection = newXDir#self.xDirection
